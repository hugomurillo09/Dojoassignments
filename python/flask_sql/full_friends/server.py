...
def index():
    ...
    friends_query = ("SELECT id, first_name, last_name, email FROM Fullfriends")
...
def create_friend():
    ...
    #validate Email, if doesn't pass executes bottom return
        ...
        create_query = ("INSERT INTO Fullfriends(first_name, last_name, email, created_at, updated_at)  VALUES(:fName, :lName, :email, NOW(), NOW())")
        friend_data = {
                        'fName': fName,
                        'lName': lName,
                        'email': email
...
def edit_friend(id):
    ...
    verify_query = ("SELECT id, first_name, last_name, email FROM Fullfriends WHERE id = :id")
    verify_data = {'id': id}
...
def update_friend(id):
    ...
    #validate Email, if doesn't pass executes bottom return
        ...
        update_query = ("UPDATE Fullfriends SET first_name = :fName, last_name = :lName, email = :email, updated_at = NOW() WHERE id = :id")
        updated_data = {
                        'fName': fName,
                        'lName': lName,
                        'email': email,
